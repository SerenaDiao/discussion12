...
// Question 1
document.getElementById('host-name').textContent = 'Yue';
document.getElementById('collaborator-name').textContent = 'Diao';
...
firstNameInput.addEventListener('input', function() {
    if (firstNameInput.value.toLowerCase() === 'john') {
        ...
        lastNameInput.value = ''; // Clear last name if first name isn't 'John'
    }
});
